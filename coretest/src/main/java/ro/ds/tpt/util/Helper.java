...
import ro.ds.util.FormattedTextReader;
...
public class Helper {
	...
	public Helper(String fileName) throws IOException {
		...
		ro.ds.util.StationsXMLReader crd = new ro.ds.util.StationsXMLReader(new FormattedTextReader(new FileInputStream("stations.xml")));
