...
public class BlackListed implements ro.ds.tpt.model.INamedEntity {
	...
	public static <T extends ro.ds.tpt.model.INamedEntity> boolean isIdListed(ro.ds.tpt.model.INamedEntity entity, Collection<T> list) {
		for(T b : list)
			if (entity.getExtId().equals(b.getExtId())) return true;
		return false;
	}

	public static <T extends ro.ds.tpt.model.INamedEntity> boolean isNameListed(ro.ds.tpt.model.INamedEntity entity, Collection<T> list) {
		for(T b : list)
