...
public class RegressionTests {
	...
	public static Test suite() throws IOException {
		...
		ro.ds.tpt.model.City cExpected = ro.ds.tpt.JavaCityLoader.loadCachedCityOrDownloadAndCache(prefs);
		//City cActual = JavaCityLoader.loadCachedCityOrDownloadAndCache(prefs);
		ro.ds.tpt.model.City cActual = ro.ds.tpt.RATT.downloadCity(prefs, new NullMonitor());
	...
	public static <T extends ro.ds.tpt.model.INamedEntity> String diffEntities(Collection<T> expected, Collection<T> actual) {
		return diffEntities(expected, actual, new ArrayList<T>(), new ArrayList<T>());
	}

	public static <T extends ro.ds.tpt.model.INamedEntity> String diffEntities(Collection<T> expected, Collection<T> actual,
																			   Collection<? extends ro.ds.tpt.model.INamedEntity> bl_expected, Collection<? extends ro.ds.tpt.model.INamedEntity> bl_actual) {
