...
public class PathView {
	...
	public static View newPathView(LayoutInflater inflater, ViewGroup parent,
								   ro.ds.tpt.model.Path linePath, View.OnClickListener clickListener, boolean isOddItem) {
	...
	public static View fillPathView(View pathView, Resources res, 
		...
		ro.ds.tpt.model.Line pathLine = path.getPath().getLine();
		ro.ds.util.LineKind lineKind = pathLine.getKind();
