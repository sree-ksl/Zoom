...
import ro.ds.tpt.LoadCity;
import ro.ds.tpt.Preferences;
import ro.ds.tpt.R;
import ro.ds.tpt.ViewUserCredits;
...
public class CityActivity extends Activity {
	private ro.ds.tpt.model.City city = null;
	private AppPreferences prefs = null;
	
	protected final ro.ds.tpt.model.City getCity() throws CityNotLoadedException {
		if(null==city) {
