...
public class Upgrade {
	...
	private void upgrade23to24(final AppPreferences prefs) {
		...
		builder
			.setMessage(ro.ds.tpt.R.string.upgrade_analytics_message)
			.setTitle(ro.ds.tpt.R.string.upgrade_analytics_title)
			.setPositiveButton(ro.ds.tpt.R.string.lblAffirmative, listener)
		    .setNegativeButton(ro.ds.tpt.R.string.lblNegative, listener)
		    .show();
