...
import ro.ds.tpt.utils.PathListViewAdapter;
...
public abstract class ViewCategories extends CityActivity {
	...
	protected abstract Iterator<Path> getLinePathIterator(ro.ds.tpt.model.City city);
	...
	protected final void onCreateCityActivity(Bundle savedInstanceState) throws CityNotLoadedException {
    	...
    	ro.ds.tpt.model.City city = getCity();
    ...
    protected final void createContent(ro.ds.tpt.model.City city) {
	...
	public static class LineKindIterator implements Iterator<Path> {
		...
		private final ro.ds.tpt.model.City city;
		
		public LineKindIterator(ro.ds.tpt.model.City city, Iterator<String> lineNameIterator) {
			this.city = city;
			this.lineNameIterator = lineNameIterator;
		}
		
		public LineKindIterator(ro.ds.tpt.model.City city, LineKind lineKind) {
		...
		public Path next() {
			...
			ro.ds.tpt.model.Line l = city.getLineByName(lineName);
			if (l == null) {
