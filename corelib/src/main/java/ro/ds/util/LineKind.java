...
public enum LineKind {
	TRAM("Tv1","Tv2","Tv4","Tv5","Tv6","Tv7","Tv8","Tv9", "Tv10"), 
	...
	public static boolean isRouteConvex(ro.ds.tpt.model.Line line) {
		return convexLines.contains(line.getName());
	}
	
	public static boolean isLineBarred(ro.ds.tpt.model.Line line) {
	...
	public static LineKind getKind(ro.ds.tpt.model.Line line) {
