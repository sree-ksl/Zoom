...
public class PathList {
	...
	public Path read(String pathCode, ro.ds.tpt.model.City c) {
		int sep = pathCode.indexOf("-");
		if (sep<=0)
			return null;
		ro.ds.tpt.model.Line line = c.getLineByName(pathCode.substring(0, sep));
		if (line == null) 
			return null;
	...
	public ArrayList<Path> readPaths(ro.ds.tpt.model.City c) {
