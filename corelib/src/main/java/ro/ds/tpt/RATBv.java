...
import ro.ds.tpt.model.HourlyPlan;
...
public class RATBv {
	...
	public static void main(String[] args) throws IOException {
		...
		ro.ds.tpt.model.Station d1Start = c.newStation("1", "Livada Postei");
		ro.ds.tpt.model.Station d1End = c.newStation("2", "Triaj");
		ro.ds.tpt.model.Station[] dir1 = {
			d1Start,
		...
		ArrayList<ro.ds.tpt.model.Station> allStations = new ArrayList<ro.ds.tpt.model.Station>();
		allStations.addAll(Arrays.asList(dir1));
		allStations.addAll(Arrays.asList(dir2));
		for (ro.ds.tpt.model.Station s: allStations) {
			s.setNiceName(s.getName());
		}
		
		
		ro.ds.tpt.model.Line l = c.newLine("1");
		...
		for (ro.ds.tpt.model.Station s: dir1) {
		...
		for (ro.ds.tpt.model.Station s: dir2) {
	...
	public static void testCityFromBytes(byte[] bytes) throws IOException {
		...
		ro.ds.util.DetachableStream inBuffer = new ro.ds.util.DetachableStream.FromBytes(bytes);
		ro.ds.tpt.model.City loadedCity = new ro.ds.tpt.model.City();
