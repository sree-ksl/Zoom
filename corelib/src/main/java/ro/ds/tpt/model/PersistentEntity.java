...
public abstract class PersistentEntity {
	...
	public static ro.ds.tpt.model.Path loadEagerPath(BPInputStream eager, City c) throws IOException {
		return ro.ds.tpt.model.Path.loadEager(eager, eager.readInt(), c);
	}	
