...
public class Station extends PersistentEntity implements INamedEntity, Serializable {
	...
	private List<ro.ds.tpt.model.Path> paths;
	private ro.ds.tpt.model.Junction junction;
	
	private Station(int id, long resId, City city) {
		super(resId, city);
		this.id = id;
		this.paths = new ArrayList<ro.ds.tpt.model.Path>(2);
	}
	...
	public String getLineNames() {
		...
		for(ro.ds.tpt.model.Path path : paths)
	...
	public List<ro.ds.tpt.model.Path> getPaths() {
		ensureLoaded();
		return paths;
	}	
	...
	public void setJunction(ro.ds.tpt.model.Junction junction) {
		this.junction = junction;
	}
	public ro.ds.tpt.model.Junction getJunction() {
		ensureLoaded();
		return junction;
	}
