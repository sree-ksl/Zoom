...
public class Path extends PersistentEntity implements Serializable {
	...
	public List<String> timesToString() {
		...
		for(Estimate e:estimatesByPath) {
			...
			b.append(" - \t");
			b.append(Formatting.formatTime(e.getTimes1()));
			b.append(", \t");
			b.append(Formatting.formatTime(e.getTimes2()));
	...
	@Override
	public void saveEagerAndLazy(ro.ds.util.BPOutputStream eager, ro.ds.util.BPMemoryOutputStream lazy) throws IOException {
	...
	static Path loadEager(ro.ds.util.BPInputStream eager, int resId, City city) throws IOException {
	...
	@Override
	protected void saveEager(ro.ds.util.BPOutputStream eager) throws IOException {
	...
	@Override
	protected void loadLazyResources(ro.ds.util.BPInputStream res) throws IOException {
	...
	@Override
	protected void saveLazyResources(ro.ds.util.BPMemoryOutputStream lazy) throws IOException {
		// lazy path resources
